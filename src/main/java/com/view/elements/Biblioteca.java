...
import com.controller.student.BibliotecaController;
import com.dto.BibliotecaDTO;
import com.view.elements.BibliotecaModal;
...
public class Biblioteca {
    ...
    private static void loadList(String status) {
        ...
        if(status.equals("todos")){
            ...
            bibliotecaList = biblioteca.loadBiblioteca().stream().filter(bibliotecaDTO -> bibliotecaDTO.isFavorite()).toList();
        }
    }
    ...
    private static VBox createBibliotecaBox(BibliotecaDTO bibliotecaDTO,String status) {
        ...
        button.setOnAction(e -> {
            BibliotecaModal modal = new BibliotecaModal(getDefaultWindow(),"C:\\Users\\steph\\Desktop\\teste 02\\teste.pdf",bibliotecaDTO);
                    });
