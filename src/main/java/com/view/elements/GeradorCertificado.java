...
public class GeradorCertificado {
    ...
    public static void gerarCertificado(String nomeAluno, String nomeCurso, int cargaHoraria, String cidade, File diretorio) {
        ...
        try {
            ...
            adicionarConteudoCertificado(documento, nomeAluno, nomeCurso, cargaHoraria, cidade,
                    fonteTitulo, fonteSubtitulo, fonteNome, fonteCurso, fonteTexto);
    ...
    private static void adicionarMarcaDagua(PdfWriter writer, Rectangle pageSize) throws DocumentException {
        PdfContentByte canvas = writer.getDirectContentUnder();
    ...
    private static void adicionarBordaElegante(PdfContentByte cb, float x, float y, float width, float height) {
        float radius = 20f;
    ...
    private static void adicionarLogo(Document documento) throws IOException, DocumentException {
        Image logo = Image.getInstance("CapyCourses\\src\\main\\resources\\capyCourses.png");
        float logoSize = 120;
    ...
    private static void adicionarConteudoCertificado(Document documento, String nomeAluno,
    ...
    private static void adicionarParagrafo(Document doc, String texto, Font fonte,
            int alinhamento, int espacos) throws DocumentException {
