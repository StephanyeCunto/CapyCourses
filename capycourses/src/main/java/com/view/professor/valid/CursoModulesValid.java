            ...
            for (Node moduleNode : moduleList.getChildren()) {
                ...
                if (lessonList.getChildren().size() < 2) {
                    ErrorNotification errorNotification = new ErrorNotification(
                            parentContainer,
                            "Adicione uma aula no módulo "+ (moduleIndexTrue));
