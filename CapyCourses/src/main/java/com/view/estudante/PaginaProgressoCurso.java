...
public class PaginaProgressoCurso implements Initializable {
    ...
    private VBox start() {
        ...
        recentActivities.getColumns().addAll(dateColumn, activityColumn, courseColumn, moduleColumn, statusColumn);
    ...
    private void changeMode() {
        ...
        if (!Modo.getInstance().getModo()) {
            ...
            container.getStylesheets()
                    .add(getClass().getResource("/com/estudante/progresso/style/ligth/style.css").toExternalForm());
        } else {
            background.getStyleClass().remove("dark");
            container.getStylesheets()
                    .add(getClass().getResource("/com/estudante/progresso/style/dark/style.css").toExternalForm());
        }
    }
}
