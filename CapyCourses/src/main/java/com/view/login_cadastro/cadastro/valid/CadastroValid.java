...
public class CadastroValid {
    ...
    public void setupInitialState(TextField textFieldName, TextField textFieldEmail,
            PasswordField passwordFieldPassword, PasswordField passwordFieldPasswordConfirm,
            Label userNameErrorLabel, Label userEmailErrorLabel, Label passwordErrorLabel,
            Label passwordConfirmErrorLabel) {

        initComponents(textFieldName, textFieldEmail, passwordFieldPassword,
                passwordFieldPasswordConfirm, userNameErrorLabel, userEmailErrorLabel,
                passwordErrorLabel, passwordConfirmErrorLabel);

        configurarValidacoes();
    }

    private void initComponents(TextField textFieldName, TextField textFieldEmail,
            PasswordField passwordFieldPassword, PasswordField passwordFieldPasswordConfirm,
            Label userNameErrorLabel, Label userEmailErrorLabel, Label passwordErrorLabel,
            Label passwordConfirmErrorLabel) {
    ...
    private void configurarValidacaoNome() {
        textFieldName.textProperty().addListener((obs, oldVal, newVal) -> 
            atualizarEstadoNome(newVal));
    ...
    private void validarCampoNome() {
        validationSupport.registerValidator(textFieldName, false,
            Validator.createPredicateValidator(value -> 
                validarNome((String) value), MSG_NOME_INVALIDO));
    }
    ...
    private void configurarValidacaoEmail() {
        textFieldEmail.textProperty().addListener((obs, oldVal, newVal) -> 
            atualizarEstadoEmail(newVal));
    ...
    private void validarCampoEmail() {
        validationSupport.registerValidator(textFieldEmail, false,
            Validator.createPredicateValidator(value -> 
                validarEmail((String) value), MSG_EMAIL_INVALIDO));
    }
    ...
    private void configurarValidacaoSenha() {
        passwordFieldPassword.textProperty().addListener((obs, oldVal, newVal) -> 
            atualizarEstadoSenha(newVal));
    ...
    private void validarCampoSenha() {
        validationSupport.registerValidator(passwordFieldPassword, false,
            Validator.createPredicateValidator(value -> 
                validarSenha((String) value), MSG_SENHA_TAMANHO));
    }
    ...
    private void configurarConfirmacaoSenha() {
        passwordFieldPasswordConfirm.textProperty().addListener((obs, oldVal, newVal) -> 
            atualizarEstadoConfirmacaoSenha());
    ...
    private void validarConfirmacaoSenha() {
        validationSupport.registerValidator(passwordFieldPasswordConfirm, false,
            Validator.createPredicateValidator(value -> 
                validarConfirmacaoSenha((String) value), MSG_CONFIRMACAO_SENHA));
    }
    ...
    public boolean validateFields() {
        ...
        if (!validarConfirmacaoSenha(confirmacao)) {
            updateErrorDisplay(passwordFieldPasswordConfirm, passwordConfirmErrorLabel, false, MSG_CONFIRMACAO_SENHA);
            isValid = false;
        }
