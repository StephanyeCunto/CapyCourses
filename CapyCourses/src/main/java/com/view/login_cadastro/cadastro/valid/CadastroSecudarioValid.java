...
public class CadastroSecudarioValid {
            ...
            (obs, old, newText) -> {
              ...
              if (sizePhone() == 14) {
                ...
                updateErrorDisplay(
                    ...
                    phoneErrorLabel,
                    true,
                    "Por favor, insira um telefone válido"); // Mostra o erro
              }
            });
  ...
  public boolean validateFields() {
    ...
    if (sizePhone() < 14) {
      updateErrorDisplay(
          textFieldPhone, phoneErrorLabel, true, "Por favor, insira um telefone válido");
      isValid = false;
    }
    if (comboBoxEducation.getValue() == null || comboBoxEducation.getValue().trim().isEmpty()) {
      updateErrorDisplay(
          comboBoxEducation, educationErrorLabel, true, "Por favor, selecione uma opção válida");
      isValid = false;
    }
