...
public class CreateJson {
  ...
  public static void verifyAndDeleteLoginData(
      String userName, String userPassword, String filePath) {
    ObjectMapper mapper = new ObjectMapper();
    try {
      LoginJsonController savedLogin =
          mapper.readValue(new File(filePath), LoginJsonController.class);
      if (savedLogin.getUserName().equals(userName)
          && savedLogin.getUserPassword().equals(userPassword)) {
