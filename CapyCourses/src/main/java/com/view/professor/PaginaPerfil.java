...
import com.view.elements.Perfil.PreferencesSection;
import com.view.elements.Perfil.PrivacySection;
import com.view.elements.Perfil.ProfileCard;
import com.view.elements.Perfil.SecuritySection;
...
public class PaginaPerfil implements Initializable {
  ...
  @FXML private Button segurityBtn;
  ...
  private void changeMode() {
    ...
    if (!Modo.getInstance().getModo()) {
      ...
      content
          .getStylesheets()
          .add(
              getClass().getResource("/com/elements/stylePerfil/ligth/style.css").toExternalForm());
    } else {
