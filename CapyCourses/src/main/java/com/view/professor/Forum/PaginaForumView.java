package com.view.professor.Forum;

import com.view.Modo;
import com.view.elements.Forum.ModalAddForum;
...
public class PaginaForumView implements Initializable {
  ...
  @FXML private Button selectionParticipated;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    Platform.runLater(
        () -> {
          ...
          selectionParticipated.setOnMouseClicked(
              e -> {
          ...
          javafx.animation.Timeline timeline =
              new javafx.animation.Timeline(
                  new javafx.animation.KeyFrame(
                      Duration.ZERO,
                      new javafx.animation.KeyValue(addButton.prefWidthProperty(), 40)),
                  new javafx.animation.KeyFrame(
                      Duration.millis(200),
                      new javafx.animation.KeyValue(addButton.prefWidthProperty(), 120)));
          timeline.play();
        });
  ...
  private void loadMenu() {
    try {
      ...
      menuController.setCurrentPage("/com/professor/forum/paginaForum");
