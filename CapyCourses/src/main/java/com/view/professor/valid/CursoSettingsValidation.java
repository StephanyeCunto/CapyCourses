...
public class CursoSettingsValidation {
  ...
  public void setupInitialState(
      TextField durationTotal,
      ComboBox<String> comboBoxVisibility,
  ...
  private void addRealTimeValidationListeners() {
            ...
            (observable, oldValue, newValue) -> {
              boolean isValid =
                  newValue != null
                      ...
                      && newValue.matches("^\\d+(\\.\\d+)?$");
              updateErrorDisplay(
                  durationTotal,
                  durationTotalErrorLabel,
                  !isValid,
    ...
    comboBoxVisibility
        ...
        .addListener(
            (observable, oldValue, newValue) -> {
              boolean isValid =
                  newValue != null && !newValue.trim().isEmpty() && !newValue.equals("null");
              updateErrorDisplay(
                  comboBoxVisibility,
  ...
  public boolean validateFields() {
    ...
    if (durationTotal.getText() == null
        || durationTotal.getText().trim().isEmpty()
        || !durationTotal.getText().matches("^\\d+(\\.\\d+)?$")) {
      updateErrorDisplay(
          durationTotal, durationTotalErrorLabel, true, "Por favor, insira uma duração válida");
      isValid = false;
    }
  ...
  private void updateErrorDisplay(
      Control field, Label errorLabel, boolean hasError, String message) {
