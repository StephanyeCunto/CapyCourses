...
public class PrivacySection {
  ...
  public VBox createPrivacySection() {
    ...
    Label privacyUpdateLabel =
        new Label("Última atualização da política de privacidade: 15/12/2024");
    ...
    privacyPolicyButton.setOnAction(
        e -> new PrivacyPolicyModal(privacyPolicyButton.getScene().getWindow()));
    ...
    vbox.getChildren()
        .addAll(privacyTitle, consentSection, dataManagementSection, privacyInfoSection);
