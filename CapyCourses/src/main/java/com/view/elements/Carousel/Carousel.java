...
public class Carousel {
  @FXML private Button rigthButton;
  @FXML private VBox rigthContainer;
  @FXML private Button leftButton;
  @FXML private HBox indicator;
  ...
  public void loadCarousel() {
    ...
    rigthButton.setOnMouseEntered(
        event -> {
          try {
            InputStream stream =
                getClass().getResourceAsStream("/com/icons/seta-carrosel-hover.png");
            if (stream == null) {
  ...
  private void startAutoCarousel() {
    ...
    try {
      ...
      rigthContainer.setOnMouseEntered(
          event -> {
            try {
              timeline.stop();
            } catch (Exception e) {
      ...
      rigthContainer.setOnMouseExited(
          event -> {
            try {
              timeline.stop();
              timeline.play();
  ...
  private VBox createCourseBoxCarousel(PaginaPrincipalDTO course) {
    ...
    Label titleLabel =
        createFixedLabel(course.getTitle(), "Franklin Gothic Medium", 24, Color.WHITE);
    ...
    Label authorLabel =
        createFixedLabel(
            "Por " + course.getName(), "Franklin Gothic Medium", 14, Color.web("#ffffff90"));
    ...
    Label descLabel =
        createFixedLabel(
            course.getDescription(), "Franklin Gothic Medium", 14, Color.web("#ffffff90"));
  ...
  private Button createDetailsButton(PaginaPrincipalDTO course) {
    ...
    button.setOnMouseEntered(
        e -> button.setStyle("-fx-border-radius: 20; -fx-background-radius: 20;"));
