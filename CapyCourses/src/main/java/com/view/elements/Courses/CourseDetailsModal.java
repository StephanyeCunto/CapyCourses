...
public class CourseDetailsModal {
    ...
    private void showCourseDetails(String courseTitle, String name,
            ...
            LocalDate dateEnd, String durationTotal, Boolean isDateEnd, Boolean isCertificate) {
        ...
        if (isDateEnd && dateEnd != null) {
            Label dateEndLabel = createStyledLabel("Data de Término: " + dateEnd.toString(), "Segoe UI", 14);
