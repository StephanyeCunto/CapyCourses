...
public class ModalAddForum {
  ...
  private void showModel() {
    ...
    createForumValid.setupInitialState(
        forumTitleField,
    ...
    saveButton.setOnAction(
        e -> {
          if (createForumValid.isValid()) {
            //  controller.addForum(forumTitleField.getText(), forumDescriptionField.getText(),
            // categoryTextField.getText(), questionTextArea.getText());
            modalStage.close();
            handleSave(
                forumTitleField.getText(),
                forumDescriptionField.getText(),
            ...
            try {
              ...
              FXMLLoader loader =
                  new FXMLLoader(
                      LoadForumView.class.getResource("/com/estudante/forum/paginaDoForum.fxml"));
