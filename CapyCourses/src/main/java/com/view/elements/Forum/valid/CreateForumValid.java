...
public class CreateForumValid {
  ...
  public boolean isValid() {
    ...
    if (!isValidDescription(description.getText())) {
      updateErrorDisplay(
          description, descriptionErrorLabel, false, "Por favor, digite uma descrição válida");
      isValid = false;
    }
    if (!isValidCategory(category.getText())) {
      updateErrorDisplay(
          category, categoryErrorLabel, false, "Por favor, digite uma categoria válida");
      isValid = false;
    }
    if (!isValidQuestion(question.getText())) {
      updateErrorDisplay(
          question, questionErrorLabel, false, "Por favor, digite uma pergunta válida");
      isValid = false;
    }
    return isValid;
  }
