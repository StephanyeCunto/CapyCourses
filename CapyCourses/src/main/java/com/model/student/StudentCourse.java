...
public class StudentCourse {
  ...
  @Column private LocalDate completionDate;

  @Column private Integer progress;

  @Column private String status; // "not_started", "in_progress", "completed"
  ...
  @Column private Integer completedLessons = 0;

  @Column private Integer totalLessons = 0;

  @Column private Integer completedQuestionaires = 0;

  @Column private Integer totalQuestionaires = 0;
  ...
  public void updateProgress() {
    ...
    this.completedLessons =
        (int) lessonProgresses.stream().filter(LessonProgress::isCompleted).count();
