...
public class ForumDatabase {
  ...
  public void addComment(String forumTitle, ForumComentarioDTO commentDTO) {
    ...
    try {
      ...
      TypedQuery<Forum> query =
          em.createQuery("SELECT f FROM Forum f WHERE f.title = :title", Forum.class);
  ...
  public List<ForumDTO> getAllForums() {
    ...
    try {
      TypedQuery<Forum> query =
          em.createQuery("SELECT f FROM Forum f ORDER BY f.dateTime DESC", Forum.class);
