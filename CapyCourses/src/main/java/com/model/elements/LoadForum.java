...
public class LoadForum {
  public List<ForumDTO> LoadForum() {
    ...
    try (BufferedReader br =
        new BufferedReader(new FileReader("capycourses/src/main/resources/com/bd/bd_forum.csv"))) {
      String line;
  ...
  public void addView(ForumDTO forumData) {
    ...
    try (java.io.FileWriter fw =
        new java.io.FileWriter("capycourses/src/main/resources/com/bd/bd_forum.csv")) {
      for (ForumDTO forum : forums) {
        fw.write(
            forum.getAuthor()
                + ","
  ...
  public void curtir(String title, String user) {
    try (java.io.FileWriter fw =
        new java.io.FileWriter("capycourses/src/main/resources/com/bd/bd_forum_likes.csv", true)) {
      fw.write(title + "," + user + "\n");
    } catch (IOException e) {
      e.printStackTrace();
    }
  ...
  public void desCurtir(String title, String user) {
    ...
    try (java.io.FileWriter fw =
        new java.io.FileWriter("capycourses/src/main/resources/com/bd/bd_forum_likes.csv")) {
  ...
  public void addComentario(String title, String comentario) {
    try (java.io.FileWriter fw =
        new java.io.FileWriter(
            "capycourses/src/main/resources/com/bd/bd_forum_comentarios.csv", true)) {
      fw.write(
          title
              + ","
