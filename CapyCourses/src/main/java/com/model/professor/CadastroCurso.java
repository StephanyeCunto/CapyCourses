...
public class CadastroCurso {
  ...
  private void registerquestionaire(
      List<Map<String, Object>> questionaire,
      String title,
      String moduleTitle,
          ...
          new Thread(
              () -> {
                try (BufferedWriter writer =
                    new BufferedWriter(
                        new FileWriter(
                            "CapyCourses\\src\\main\\resources\\com\\bd\\bd_questionaire.csv",
                            true))) {
                  writer.write(
                      title
                          + ","
            ...
            new Thread(
                () -> {
                  try (BufferedWriter writer =
                      new BufferedWriter(
                          new FileWriter(
                              "CapyCourses\\src\\main\\resources\\com\\bd\\bd_questions.csv",
                              true))) {
                    writer.write(
                        title
                            + ","
  ...
  private void registerClasses(
      List<Map<String, Object>> lessons, String title, String moduleTitle, Integer moduleNumber) {
    try {
            ...
            new Thread(
                () -> {
                  try (BufferedWriter writer =
                      new BufferedWriter(
                          new FileWriter(
                              "CapyCourses\\src\\main\\resources\\com\\bd\\bd_aulas.csv", true))) {
                    writer.write(
                        title
                            + ","
                            + moduleTitle
  ...
  private void registerSettings(
    ...
    try (BufferedWriter writer =
        new BufferedWriter(
            new FileWriter(
                "CapyCourses\\src\\main\\resources\\com\\bd\\bd_settingsCurso.csv", true))) {
      writer.write(
          title
              + ","
              + dateStart
